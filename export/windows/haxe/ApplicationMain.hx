...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PaintJam2021", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PaintJam2021", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "hdboye";
		app.meta["file"] = "PaintJam2021";
		app.meta["name"] = "Paint Jam 2021 Game";
		app.meta["packageName"] = "com.example.myapp";
		app.meta["version"] = "Jam";
