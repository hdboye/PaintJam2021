...
class HXCPP_CLASS_ATTRIBUTES FlxMouseEventManager_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		static ::Array< ::Dynamic> _mouseDownObjects;
		static ::Array< ::Dynamic> _mouseClickedObjects;
		static int _mouseClickedTime;
		static  ::flixel::math::FlxPoint _point;
		static int maxDoubleClickDelay;
		static void init();
		...
		static int sortByMouseChildren( ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg1, ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg2);
		static ::Dynamic sortByMouseChildren_dyn();
