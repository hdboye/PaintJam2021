...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("PaintJam2021",f5,b5,eb,7e),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("hdboye",d5,15,4b,6a));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("PaintJam2021",f5,b5,eb,7e));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Paint Jam 2021 Game",09,63,d9,ea));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.myapp",84,30,57,c1));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("Jam",b6,7b,38,00));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Paint Jam 2021 Game",09,63,d9,ea))
