...
bool RegisterMap_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1c829faf;
}
...
HXLINE( 620)		 ::openfl::display3D::_internal::agal::_AGALConverter::RegisterMapEntry entry =  ::openfl::display3D::_internal::agal::_AGALConverter::RegisterMapEntry_obj::__alloc( HX_CTX );
