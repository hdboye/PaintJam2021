...
HXLINE( 497)				fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/timesbi.ttf",36,79,1a,28)));
            			}
            			else {
HXLINE( 501)				fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/timesbd.ttf",b1,92,19,47)));
            			}
            		}
            		else {
HXLINE( 506)			if (( (bool)(format->italic) )) {
HXLINE( 508)				fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/timesi.ttf",ca,27,e8,a0)));
            			}
            			else {
HXLINE( 512)				fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/times.ttf",2f,58,44,c5)));
            			}
            		}
HXLINE( 534)		{
HXLINE( 534)			int _g = 0;
